...
public class AliyunSendPhoneUtil {
    ...
    private static SendSmsResponse sendPhoneCode(String phoneNumbers,String signName,String templateCode,String templateParam) throws ClientException {
        ...
        //替换成你的AK                   LTAI4FuYtJia246XD7SK55nj
        final String accessKeyId = "LTAI4FuYtJia246XD7SK55nj";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "K1yNZh215gNbaXSVdhBM3c8LNYcS61";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendCode(String phones,String code){
        ...
        String signName="生鲜果蔬";  //签名
        String templateCode="SMS_187460168";  //模板
